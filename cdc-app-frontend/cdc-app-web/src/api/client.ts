...
export const api = {
  projeler: {
    ...
    create: (data: Partial<Proje>) =>
      request<void>("/v1/projects/create", { method: "POST", body: JSON.stringify(data) }),
    update: (id: string, data: Partial<Proje>) =>
      request<void>(`/v1/projects/update/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
    delete: (id: string) =>
  ...
  haberler: {
    ...
    create: (data: Partial<Haber>) =>
      request<void>("/v1/news/create", { method: "POST", body: JSON.stringify(data) }),
    update: (id: string, data: Partial<Haber>) =>
      request<void>(`/v1/news/update/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
    delete: (id: string) =>
